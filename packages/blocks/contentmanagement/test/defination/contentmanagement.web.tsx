...
import ImageCotent from "../../src/ImageContent.web";
import VideoContent from "../../src/VideoContent.web";
...
defineFeature(feature, (test) => {
  ...
  test("User navigates to ContentManagement", ({ given, when, then }) => {
    ...
    let instanceImage: ImageCotent;

    let exampleBlockC: ShallowWrapper;
    let instanceVideo: VideoContent;
    ...
    then("I can see the products", () => {
      ...
      exampleBlockB = shallow(<ImageCotent {...screenProps} />);
      instanceImage = exampleBlockB.instance() as ImageCotent;
      ...
      exampleBlockC = shallow(<VideoContent {...screenProps} />);
      instanceVideo = exampleBlockC.instance() as VideoContent;
