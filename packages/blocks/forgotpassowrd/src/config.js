...
exports.pwdRegEx = `^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.{8,})`;
exports.sendLinkApiEndPoint = 'bx_block_forgot_password/passwords/forgot_password_link'
exports.postMethod= 'POST'
exports.arrOfLanguages = [{label:"English",value:"en"}]
exports.resetPasswordApi = "/bx_block_forgot_password/passwords/reset_password"
exports.contentTypeApplicatioJson = "application/json"
